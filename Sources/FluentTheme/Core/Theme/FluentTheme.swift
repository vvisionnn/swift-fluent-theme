...
public class FluentTheme: NSObject, ObservableObject {
	...
	public init(
		...
		let mappedTypographyOverrides = typographyOverrides?.compactMapValues { font in
			FontInfo(name: font.fontName, size: font.pointSize)
		}
	...
	public func tokens<T: TokenSetKey>(for tokenSetType: ControlTokenSet<T>.Type) -> [T: ControlTokenValue]? {
		controlTokenSets[tokenKey(tokenSetType)] as? [T: ControlTokenValue]
	}
	...
	public static func isApplicableThemeChange(
...
extension Notification.Name {
	...
	public static let didChangeTheme = Notification.Name("FluentUI.stylesheet.theme")
}
