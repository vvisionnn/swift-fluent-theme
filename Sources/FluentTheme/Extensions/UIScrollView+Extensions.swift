...
extension UIScrollView {
	...
	var scrollLocationDescriptor: ScrollLocationDescriptor {
		...
		let contentHeight = contentSize
			.height + topInset +
			bottomInset // bottom inset can vary within the same list as the footer is dynamically loaded during scrolling (i.e. it will equal 1.0 until the footer is actually dequeued)
